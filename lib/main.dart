...
import 'package:test1/loading_screen.dart';
...
import 'package:test1/screens/stats_screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Data profil sementara (dummy data)
    UserData user = UserData(
        name: 'John Doe rain',
        phoneNumber: '+1 234 5678',
        email: 'johndoe@example.com',
        profileImageUrl: 'assets/images/Black girl.jpeg');
